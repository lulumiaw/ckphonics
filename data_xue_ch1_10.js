    ...
    topics: [
      {
        ...
        words: [
          { word: "bad",  highlight: "a", zh: "壞的", emoji: "😈", search: "bad evil", phonemes: ["b","a","d"], phonemesSpeak: [null, "at", null] },
          { word: "bat",  highlight: "a", zh: "球棒/蝙蝠", emoji: "🦇", search: "bat", phonemes: ["b","a","t"], phonemesSpeak: [null, "at", null] },
          { word: "cat",  highlight: "a", zh: "貓", emoji: "🐱", search: "cat", phonemes: ["c","a","t"], phonemesSpeak: [null, "at", null] },
          { word: "cap",  highlight: "a", zh: "帽子", emoji: "🧢", search: "cap hat", phonemes: ["c","a","p"], phonemesSpeak: [null, "at", null] },
          { word: "fat",  highlight: "a", zh: "胖的", emoji: "🐷", search: "fat pig", phonemes: ["f","a","t"], phonemesSpeak: [null, "at", null] },
          { word: "hand", highlight: "a", zh: "手", emoji: "✋", search: "hand", phonemes: ["h","a","nd"], phonemesSpeak: [null, "at", null] },
          { word: "hat",  highlight: "a", zh: "帽子", emoji: "🎩", search: "hat", phonemes: ["h","a","t"], phonemesSpeak: [null, "at", null] },
          { word: "map",  highlight: "a", zh: "地圖", emoji: "🗺️", search: "map", phonemes: ["m","a","p"], phonemesSpeak: [null, "at", null] },
          { word: "pan",  highlight: "a", zh: "平底鍋", emoji: "🍳", search: "pan frying", phonemes: ["p","a","n"], phonemesSpeak: [null, "at", null] },
          { word: "rat",  highlight: "a", zh: "老鼠", emoji: "🐀", search: "rat mouse", phonemes: ["r","a","t"], phonemesSpeak: [null, "at", null] }
        ],
        quiz: [
      ...
      },
      {
        ...
        words: [
          { word: "bet",  highlight: "e", zh: "打賭", emoji: "🎲", search: "bet dice", phonemes: ["b","e","t"], phonemesSpeak: [null, "Ed", null] },
          { word: "jet",  highlight: "e", zh: "噴射機", emoji: "✈️", search: "jet airplane", phonemes: ["j","e","t"], phonemesSpeak: [null, "Ed", null] },
          { word: "egg",  highlight: "e", zh: "蛋", emoji: "🥚", search: "egg", phonemes: ["e","gg"], phonemesSpeak: ["Ed", null] },
          { word: "leg",  highlight: "e", zh: "腿", emoji: "🦵", search: "leg", phonemes: ["l","e","g"], phonemesSpeak: [null, "Ed", null] },
          { word: "let",  highlight: "e", zh: "讓", emoji: "🙌", search: "let allow", phonemes: ["l","e","t"], phonemesSpeak: [null, "Ed", null] },
          { word: "net",  highlight: "e", zh: "網子", emoji: "🥅", search: "net goal", phonemes: ["n","e","t"], phonemesSpeak: [null, "Ed", null] },
          { word: "pen",  highlight: "e", zh: "筆", emoji: "✏️", search: "pen pencil", phonemes: ["p","e","n"], phonemesSpeak: [null, "Ed", null] },
          { word: "pet",  highlight: "e", zh: "寵物", emoji: "🐶", search: "pet dog", phonemes: ["p","e","t"], phonemesSpeak: [null, "Ed", null] },
          { word: "red",  highlight: "e", zh: "紅色", emoji: "🔴", search: "red color", phonemes: ["r","e","d"], phonemesSpeak: [null, "Ed", null] },
          { word: "ten",  highlight: "e", zh: "十", emoji: "🔟", search: "number ten", phonemes: ["t","e","n"], phonemesSpeak: [null, "Ed", null] }
        ],
        quiz: [
      ...
      },
      {
        ...
        words: [
          { word: "big",  highlight: "i", zh: "大的", emoji: "🏔️", search: "big mountain", phonemes: ["b","i","g"], phonemesSpeak: [null, "it", null] },
          { word: "bit",  highlight: "i", zh: "一點", emoji: "🤏", search: "bit small", phonemes: ["b","i","t"], phonemesSpeak: [null, "it", null] },
          { word: "dig",  highlight: "i", zh: "挖", emoji: "⛏️", search: "dig shovel", phonemes: ["d","i","g"], phonemesSpeak: [null, "it", null] },
          { word: "fin",  highlight: "i", zh: "魚鰭", emoji: "🐟", search: "fish fin", phonemes: ["f","i","n"], phonemesSpeak: [null, "it", null] },
          { word: "fit",  highlight: "i", zh: "合身的", emoji: "👔", search: "fit clothes", phonemes: ["f","i","t"], phonemesSpeak: [null, "it", null] },
          { word: "kid",  highlight: "i", zh: "孩子", emoji: "👦", search: "kid child", phonemes: ["k","i","d"], phonemesSpeak: [null, "it", null] },
          { word: "lip",  highlight: "i", zh: "嘴唇", emoji: "💋", search: "lip mouth", phonemes: ["l","i","p"], phonemesSpeak: [null, "it", null] },
          { word: "sit",  highlight: "i", zh: "坐", emoji: "🪑", search: "chair sit", phonemes: ["s","i","t"], phonemesSpeak: [null, "it", null] },
          { word: "six",  highlight: "i", zh: "六", emoji: "6️⃣", search: "number six", phonemes: ["s","i","x"], phonemesSpeak: [null, "it", null] },
          { word: "win",  highlight: "i", zh: "贏", emoji: "🏆", search: "win trophy", phonemes: ["w","i","n"], phonemesSpeak: [null, "it", null] }
        ],
        quiz: [
      ...
      },
      {
        ...
        words: [
          { word: "box",  highlight: "o", zh: "箱子", emoji: "📦", search: "box cardboard", phonemes: ["b","o","x"], phonemesSpeak: [null, "on", null] },
          { word: "cop",  highlight: "o", zh: "警察", emoji: "👮", search: "police cop", phonemes: ["c","o","p"], phonemesSpeak: [null, "on", null] },
          { word: "fog",  highlight: "o", zh: "霧", emoji: "🌫️", search: "fog mist", phonemes: ["f","o","g"], phonemesSpeak: [null, "on", null] },
          { word: "hot",  highlight: "o", zh: "熱的", emoji: "🔥", search: "hot fire", phonemes: ["h","o","t"], phonemesSpeak: [null, "on", null] },
          { word: "mop",  highlight: "o", zh: "拖把", emoji: "🧹", search: "mop cleaning", phonemes: ["m","o","p"], phonemesSpeak: [null, "on", null] },
          { word: "nod",  highlight: "o", zh: "點頭", emoji: "😊", search: "nod yes", phonemes: ["n","o","d"], phonemesSpeak: [null, "on", null] },
          { word: "not",  highlight: "o", zh: "不是", emoji: "🚫", search: "not no", phonemes: ["n","o","t"], phonemesSpeak: [null, "on", null] },
          { word: "fox",  highlight: "o", zh: "狐狸", emoji: "🦊", search: "fox", phonemes: ["f","o","x"], phonemesSpeak: [null, "on", null] },
          { word: "rod",  highlight: "o", zh: "棒子", emoji: "🎣", search: "rod fishing", phonemes: ["r","o","d"], phonemesSpeak: [null, "on", null] },
          { word: "top",  highlight: "o", zh: "頂部", emoji: "🔝", search: "top above", phonemes: ["t","o","p"], phonemesSpeak: [null, "on", null] }
        ],
        quiz: [
      ...
      },
      {
        ...
        words: [
          { word: "bun",  highlight: "u", zh: "小圓麵包", emoji: "🍞", search: "bun bread", phonemes: ["b","u","n"], phonemesSpeak: [null, "up", null] },
          { word: "bus",  highlight: "u", zh: "公車", emoji: "🚌", search: "bus", phonemes: ["b","u","s"], phonemesSpeak: [null, "up", null] },
          { word: "but",  highlight: "u", zh: "但是", emoji: "🤷", search: "but however", phonemes: ["b","u","t"], phonemesSpeak: [null, "up", null] },
          { word: "cup",  highlight: "u", zh: "杯子", emoji: "☕", search: "cup mug", phonemes: ["c","u","p"], phonemesSpeak: [null, "up", null] },
          { word: "cut",  highlight: "u", zh: "剪切", emoji: "✂️", search: "cut scissors", phonemes: ["c","u","t"], phonemesSpeak: [null, "up", null] },
          { word: "hug",  highlight: "u", zh: "擁抱", emoji: "🤗", search: "hug embrace", phonemes: ["h","u","g"], phonemesSpeak: [null, "up", null] },
          { word: "gun",  highlight: "u", zh: "槍", emoji: "🔫", search: "gun toy", phonemes: ["g","u","n"], phonemesSpeak: [null, "up", null] },
          { word: "gum",  highlight: "u", zh: "口香糖", emoji: "🫧", search: "gum bubble", phonemes: ["g","u","m"], phonemesSpeak: [null, "up", null] },
          { word: "sun",  highlight: "u", zh: "太陽", emoji: "☀️", search: "sun sunshine", phonemes: ["s","u","n"], phonemesSpeak: [null, "up", null] },
          { word: "tub",  highlight: "u", zh: "浴缸", emoji: "🛁", search: "tub bath", phonemes: ["t","u","b"], phonemesSpeak: [null, "up", null] }
        ],
        quiz: [
    ...
    topics: [
      {
        ...
        words: [
          { word: "bake",  highlight: "a_e", zh: "烤（長a）", emoji: "🍞", search: "bake bread", phonemes: ["b","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "cake",  highlight: "a_e", zh: "蛋糕（長a）", emoji: "🎂", search: "cake", phonemes: ["c","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "lake",  highlight: "a_e", zh: "湖（長a）", emoji: "🏞️", search: "lake", phonemes: ["l","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "name",  highlight: "a_e", zh: "名字（長a）", emoji: "🪪", search: "name tag", phonemes: ["n","a","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "bike",  highlight: "i_e", zh: "腳踏車（長i）", emoji: "🚲", search: "bicycle bike", phonemes: ["b","i","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "kite",  highlight: "i_e", zh: "風箏（長i）", emoji: "🪁", search: "kite flying", phonemes: ["k","i","t","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "rice",  highlight: "i_e", zh: "米飯（長i）", emoji: "🍚", search: "rice bowl", phonemes: ["r","i","c","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "note",  highlight: "o_e", zh: "筆記（長o）", emoji: "📝", search: "note paper", phonemes: ["n","o","t","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "home",  highlight: "o_e", zh: "家（長o）", emoji: "🏠", search: "home house", phonemes: ["h","o","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "cute",  highlight: "u_e", zh: "可愛（長u）", emoji: "🐣", search: "cute animal", phonemes: ["c","u","t","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "cube",  highlight: "u_e", zh: "正方體（長u）", emoji: "🧊", search: "cube ice", phonemes: ["c","u","b","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "huge",  highlight: "u_e", zh: "巨大（長u）", emoji: "🏔️", search: "huge mountain", phonemes: ["h","u","g","e"], phonemesSpeak: [null, null, null, ""] }
        ],
        contrastPairs: [
    ...
    topics: [
      ...
      },
      {
        ...
        words: [
          ...
          { word: "candy", highlight: "y", zh: "糖果（多音節/iː/）", emoji: "🍬", search: "candy sweet", phonemes: ["c","a","n","d","y"], phonemesSpeak: [null, "at", null, null, "ee"] },
          { word: "family",highlight: "y", zh: "家庭（多音節/iː/）", emoji: "👪", search: "family", phonemes: ["f","a","m","i","l","y"], phonemesSpeak: [null, "at", null, "it", null, "ee"] },
          { word: "funny", highlight: "y", zh: "有趣（多音節/iː/）", emoji: "😄", search: "funny laugh", phonemes: ["f","u","nn","y"], phonemesSpeak: [null, "up", null, "ee"] },
          { word: "happy", highlight: "y", zh: "快樂（多音節/iː/）", emoji: "😊", search: "happy smile", phonemes: ["h","a","pp","y"], phonemesSpeak: [null, "at", null, "ee"] }
        ],
        quiz: [
    ...
    topics: [
      ...
      },
      {
        ...
        words: [
          ...
          { word: "yell",  highlight: "ell", zh: "大叫", emoji: "📣", search: "yell shout", phonemes: ["y","ell"], phonemesSpeak: ["yuh", null] }
        ],
        quiz: [
    ...
    topics: [
      {
        ...
        words: [
          { word: "flute",   highlight: "u_e", zh: "長笛", emoji: "🎷", search: "flute instrument", phonemes: ["fl","u","t","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "rule",    highlight: "u_e", zh: "規則", emoji: "📏", search: "rule ruler", phonemes: ["r","u","l","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "cute",    highlight: "u_e", zh: "可愛", emoji: "🐣", search: "cute animal", phonemes: ["c","u","t","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "cube",    highlight: "u_e", zh: "正方體", emoji: "🧊", search: "cube ice", phonemes: ["c","u","b","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "tune",    highlight: "u_e", zh: "曲調", emoji: "🎵", search: "music tune", phonemes: ["t","u","n","e"], phonemesSpeak: [null, null, null, ""] },

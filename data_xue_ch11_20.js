    ...
    topics: [
      {
        ...
        words: [
          ...
          { word: "more",  highlight: "or", zh: "更多", emoji: "➕", search: "more plus", phonemes: ["m","or","e"], phonemesSpeak: [null, null, ""] },
    ...
    topics: [
      {
        ...
        words: [
          { word: "black",  highlight: "bl", zh: "黑色", emoji: "🖤", search: "black color", phonemes: ["bl","a","ck"], phonemesSpeak: [null, "at", null] },
          ...
          { word: "class",  highlight: "cl", zh: "班級", emoji: "🏫", search: "class school", phonemes: ["cl","a","ss"], phonemesSpeak: [null, "at", null] },
          ...
          { word: "flag",   highlight: "fl", zh: "旗幟", emoji: "🚩", search: "flag", phonemes: ["fl","a","g"], phonemesSpeak: [null, "at", null] },
          ...
          { word: "glass",  highlight: "gl", zh: "玻璃/杯子", emoji: "🥃", search: "glass cup", phonemes: ["gl","a","ss"], phonemesSpeak: [null, "at", null] },
          { word: "glad",   highlight: "gl", zh: "高興的", emoji: "😊", search: "glad happy", phonemes: ["gl","a","d"], phonemesSpeak: [null, "at", null] },
    ...
    topics: [
      {
        ...
        words: [
          ...
          { word: "bridge",  highlight: "br", zh: "橋", emoji: "🌉", search: "bridge", phonemes: ["br","i","dge"], phonemesSpeak: [null, "it", null] },
          ...
          { word: "drink",   highlight: "dr", zh: "喝", emoji: "🥤", search: "drink", phonemes: ["dr","i","nk"], phonemesSpeak: [null, "it", null] },
          ...
          { word: "trick",   highlight: "tr", zh: "惡作劇", emoji: "🎭", search: "trick prank", phonemes: ["tr","i","ck"], phonemesSpeak: [null, "it", null] },
          { word: "trip",    highlight: "tr", zh: "旅行", emoji: "✈️", search: "trip travel", phonemes: ["tr","i","p"], phonemesSpeak: [null, "it", null] },
    ...
    topics: [
      {
        ...
        words: [
          { word: "ash",      highlight: "sh", zh: "灰燼", emoji: "💨", search: "ash smoke", phonemes: ["a","sh"], phonemesSpeak: ["at", null] },
          { word: "cash",     highlight: "sh", zh: "現金", emoji: "💵", search: "cash money", phonemes: ["c","a","sh"], phonemesSpeak: [null, "at", null] },
          { word: "dish",     highlight: "sh", zh: "碟子", emoji: "🍽️", search: "dish plate", phonemes: ["d","i","sh"], phonemesSpeak: [null, "it", null] },
          { word: "fish",     highlight: "sh", zh: "魚", emoji: "🐟", search: "fish", phonemes: ["f","i","sh"], phonemesSpeak: [null, "it", null] },
          ...
          { word: "echo",     highlight: "ch", zh: "回聲（ch=/k/）", emoji: "🔊", search: "echo sound", phonemes: ["e","ch","o"], phonemesSpeak: ["Ed", null, null] },
          { word: "school",   highlight: "ch", zh: "學校（ch=/k/）", emoji: "🏫", search: "school", phonemes: ["sch","oo","l"] },
          { word: "Christmas",highlight: "ch", zh: "聖誕節（ch=/k/）", emoji: "🎄", search: "christmas", phonemes: ["Chr","i","st","m","a","s"], phonemesSpeak: [null, "it", null, null, null, null] }
        ],
        quiz: [
      ...
      },
      {
        ...
        words: [
          ...
          { word: "think",   highlight: "th", zh: "想（th清音）", emoji: "🤔", search: "think", phonemes: ["th","i","nk"], phonemesSpeak: [null, "it", null] },
          ...
          { word: "thin",    highlight: "th", zh: "薄的（th清音）", emoji: "📄", search: "thin paper", phonemes: ["th","i","n"], phonemesSpeak: [null, "it", null] },
          ...
          { word: "this",    highlight: "th", zh: "這個（th濁音）", emoji: "☝️", search: "this here", phonemes: ["th","i","s"], phonemesSpeak: [null, "it", null] },
          ...
          { word: "elephant",highlight: "ph", zh: "大象（ph=/f/）", emoji: "🐘", search: "elephant", phonemes: ["e","l","e","ph","a","nt"], phonemesSpeak: ["Ed", null, null, null, null, null] }
        ],
        quiz: [
    ...
    topics: [
      {
        ...
        words: [
          ...
          { word: "knock",     highlight: "kn", zh: "敲（k不發音）", emoji: "🚪", search: "knock door", phonemes: ["kn","o","ck"], phonemesSpeak: [null, "on", null] },
          { word: "knowledge", highlight: "kn", zh: "知識（k不發音）", emoji: "📚", search: "knowledge book", phonemes: ["kn","o","wl","edge"], phonemesSpeak: [null, "on", null, null] },
          { word: "castle",    highlight: "st", zh: "城堡（t不發音）", emoji: "🏰", search: "castle", phonemes: ["ca","s","t","le"], phonemesSpeak: [null, null, "", null] },
          { word: "listen",    highlight: "st", zh: "聽（t不發音）", emoji: "👂", search: "listen", phonemes: ["li","s","t","en"], phonemesSpeak: [null, null, "", null] },
          { word: "whistle",   highlight: "st", zh: "哨子（t不發音）", emoji: "🎵", search: "whistle", phonemes: ["whi","s","t","le"], phonemesSpeak: [null, null, "", null] },
          { word: "Christmas", highlight: "st", zh: "聖誕節（t不發音）", emoji: "🎄", search: "christmas", phonemes: ["Chr","i","st","m","a","s"], phonemesSpeak: [null, "it", null, null, null, null] },
          { word: "wrap",      highlight: "wr", zh: "包裝（w不發音）", emoji: "🎁", search: "wrap gift", phonemes: ["wr","a","p"], phonemesSpeak: [null, "at", null] },
          { word: "write",     highlight: "wr", zh: "寫（w不發音）", emoji: "✍️", search: "write pen", phonemes: ["wr","i","te"] },
          { word: "wrist",     highlight: "wr", zh: "手腕（w不發音）", emoji: "⌚", search: "wrist watch", phonemes: ["wr","i","st"], phonemesSpeak: [null, "it", null] },
          { word: "wrong",     highlight: "wr", zh: "錯誤（w不發音）", emoji: "❌", search: "wrong error", phonemes: ["wr","o","ng"], phonemesSpeak: [null, "on", null] }
        ],
        quiz: [
    ...
    topics: [
      {
        ...
        words: [
          { word: "city",    highlight: "c",   zh: "城市（c+i→/s/）", emoji: "🏙️", search: "city", phonemes: ["c","i","t","y"], phonemesSpeak: [null, "it", null, "ee"] },
          { word: "circle",  highlight: "c",   zh: "圓圈（c+i→/s/）", emoji: "⭕", search: "circle", phonemes: ["c","ir","c","le"] },
          { word: "cinema",  highlight: "c",   zh: "電影院（c+i→/s/）", emoji: "🎬", search: "cinema", phonemes: ["c","i","ne","ma"], phonemesSpeak: [null, "it", null, null] },
          ...
          { word: "bridge",  highlight: "dge", zh: "橋（dge=/dʒ/）", emoji: "🌉", search: "bridge", phonemes: ["br","i","dge"], phonemesSpeak: [null, "it", null] },
          { word: "cage",    highlight: "ge",  zh: "籠子（ge=/dʒ/）", emoji: "🐦", search: "cage bird", phonemes: ["c","a","ge"] },
          { word: "edge",    highlight: "dge", zh: "邊緣（dge=/dʒ/）", emoji: "🔪", search: "edge knife", phonemes: ["e","dge"], phonemesSpeak: ["Ed", null] },
          { word: "large",   highlight: "ge",  zh: "大的（ge=/dʒ/）", emoji: "🐘", search: "large elephant", phonemes: ["l","ar","ge"] },
          { word: "energy",  highlight: "g",   zh: "能量（g+y→/dʒ/）", emoji: "⚡", search: "energy lightning", phonemes: ["e","n","er","g","y"], phonemesSpeak: ["Ed", null, null, null, "ee"] },
          { word: "giant",   highlight: "g",   zh: "巨人（g+i→/dʒ/）", emoji: "🧌", search: "giant", phonemes: ["g","i","a","nt"] },
          { word: "gym",     highlight: "g",   zh: "健身房（g+y→/dʒ/）", emoji: "🏋️", search: "gym", phonemes: ["g","y","m"], phonemesSpeak: [null, "it", null] },
          { word: "giraffe", highlight: "g",   zh: "長頸鹿（g+i→/dʒ/）", emoji: "🦒", search: "giraffe", phonemes: ["g","i","r","a","ffe"], phonemesSpeak: [null, "it", null, "at", null] }
        ],
        quiz: [
    ...
    topics: [
      {
        ...
        words: [
          { word: "bomb",   highlight: "b",  zh: "炸彈（b不發音）", emoji: "💣", search: "bomb", phonemes: ["b","o","mb"], phonemesSpeak: [null, "on", null] },
          { word: "comb",   highlight: "b",  zh: "梳子（b不發音）", emoji: "🪮", search: "comb hair", phonemes: ["c","o","mb"] },
          { word: "dumb",   highlight: "b",  zh: "啞的（b不發音）", emoji: "🤐", search: "dumb silent", phonemes: ["d","u","mb"], phonemesSpeak: [null, "up", null] },
          { word: "lamb",   highlight: "b",  zh: "小羊（b不發音）", emoji: "🐑", search: "lamb sheep", phonemes: ["l","a","mb"], phonemesSpeak: [null, "at", null] },
          ...
          { word: "hour",   highlight: "h",  zh: "小時（h不發音）", emoji: "⏰", search: "hour clock", phonemes: ["h","our"], phonemesSpeak: ["", null] },
          { word: "honest", highlight: "h",  zh: "誠實（h不發音）", emoji: "💯", search: "honest truth", phonemes: ["h","on","est"], phonemesSpeak: ["", null, null] },
          { word: "calm",   highlight: "l",  zh: "平靜（l不發音）", emoji: "😌", search: "calm peaceful", phonemes: ["c","a","lm"] },
          { word: "half",   highlight: "l",  zh: "一半（l不發音）", emoji: "½", search: "half fraction", phonemes: ["h","a","lf"], phonemesSpeak: [null, "at", null] },
    ...
    topics: [
      {
        ...
        words: [
          { word: "ski",   highlight: "sk", zh: "滑雪", emoji: "⛷️", search: "ski skiing", phonemes: ["sk","i"], phonemesSpeak: [null, "ee"] },
          { word: "sky",   highlight: "sk", zh: "天空", emoji: "🌤️", search: "sky", phonemes: ["sk","y"] },
          { word: "skin",  highlight: "sk", zh: "皮膚", emoji: "🧴", search: "skin care", phonemes: ["sk","i","n"], phonemesSpeak: [null, "it", null] },
          ...
          { word: "study", highlight: "st", zh: "讀書", emoji: "📚", search: "study books", phonemes: ["st","u","d","y"], phonemesSpeak: [null, "up", null, "ee"] },

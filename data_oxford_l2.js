    ...
    topics: [
      {
        ...
        words: [
          ...
          { word: "big",  highlight: "ig", zh: "大的", emoji: "🏔️", search: "big mountain", phonemes: ["b","ig"], phonemesSpeak: [null, "igg"] },
          { word: "dig",  highlight: "ig", zh: "挖", emoji: "⛏️", search: "dig shovel", phonemes: ["d","ig"], phonemesSpeak: [null, "igg"] },
          { word: "fig",  highlight: "ig", zh: "無花果", emoji: "🍈", search: "fig fruit", phonemes: ["f","ig"], phonemesSpeak: [null, "igg"] },
          { word: "pig",  highlight: "ig", zh: "豬", emoji: "🐷", search: "pig", phonemes: ["p","ig"], phonemesSpeak: [null, "igg"] },
          { word: "wig",  highlight: "ig", zh: "假髮", emoji: "💇", search: "wig hair", phonemes: ["w","ig"], phonemesSpeak: [null, "igg"] },
    ...
    topics: [
      {
        ...
        words: [
          ...
          { word: "bug",  highlight: "ug", zh: "蟲子", emoji: "🐛", search: "bug insect", phonemes: ["b","ug"], phonemesSpeak: [null, "ugg"] },
          { word: "hug",  highlight: "ug", zh: "擁抱", emoji: "🤗", search: "hug embrace", phonemes: ["h","ug"], phonemesSpeak: [null, "ugg"] },
          { word: "jug",  highlight: "ug", zh: "壺", emoji: "🫙", search: "jug pitcher", phonemes: ["j","ug"], phonemesSpeak: [null, "ugg"] },
          { word: "mug",  highlight: "ug", zh: "馬克杯", emoji: "☕", search: "mug cup", phonemes: ["m","ug"], phonemesSpeak: [null, "ugg"] },
          { word: "rug",  highlight: "ug", zh: "地毯", emoji: "🟫", search: "rug carpet", phonemes: ["r","ug"], phonemesSpeak: [null, "ugg"] },

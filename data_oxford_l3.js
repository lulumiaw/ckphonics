    ...
    topics: [
      {
        ...
        words: [
          { word: "bake",  highlight: "ake", zh: "烤", emoji: "🍞", search: "bake bread", phonemes: ["b","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "cake",  highlight: "ake", zh: "蛋糕", emoji: "🎂", search: "cake", phonemes: ["c","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "fake",  highlight: "ake", zh: "假的", emoji: "🎭", search: "fake", phonemes: ["f","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "lake",  highlight: "ake", zh: "湖", emoji: "🏞️", search: "lake", phonemes: ["l","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "make",  highlight: "ake", zh: "製作", emoji: "🔨", search: "make craft", phonemes: ["m","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "rake",  highlight: "ake", zh: "耙子", emoji: "🌾", search: "rake garden", phonemes: ["r","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "take",  highlight: "ake", zh: "拿", emoji: "🤲", search: "take hand", phonemes: ["t","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "wake",  highlight: "ake", zh: "醒來", emoji: "⏰", search: "wake up", phonemes: ["w","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "came",  highlight: "ame", zh: "來了", emoji: "👋", search: "came arrived", phonemes: ["c","a","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "fame",  highlight: "ame", zh: "名聲", emoji: "⭐", search: "fame star", phonemes: ["f","a","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "game",  highlight: "ame", zh: "遊戲", emoji: "🎮", search: "game", phonemes: ["g","a","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "name",  highlight: "ame", zh: "名字", emoji: "🪪", search: "name tag", phonemes: ["n","a","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "same",  highlight: "ame", zh: "相同的", emoji: "🔁", search: "same equal", phonemes: ["s","a","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "cave",  highlight: "ave", zh: "洞穴", emoji: "🕳️", search: "cave", phonemes: ["c","a","v","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "wave",  highlight: "ave", zh: "海浪/揮手", emoji: "🌊", search: "wave ocean", phonemes: ["w","a","v","e"], phonemesSpeak: [null, null, null, ""] }
        ],
        quiz: [
    ...
    topics: [
      {
        ...
        words: [
          { word: "dime",  highlight: "ime", zh: "一角錢", emoji: "🪙", search: "dime coin", phonemes: ["d","i","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "lime",  highlight: "ime", zh: "萊姆", emoji: "🍋", search: "lime fruit", phonemes: ["l","i","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "mime",  highlight: "ime", zh: "默劇", emoji: "🎭", search: "mime performance", phonemes: ["m","i","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "time",  highlight: "ime", zh: "時間", emoji: "⏰", search: "time clock", phonemes: ["t","i","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "dine",  highlight: "ine", zh: "用餐", emoji: "🍽️", search: "dine restaurant", phonemes: ["d","i","n","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "fine",  highlight: "ine", zh: "好的", emoji: "👍", search: "fine good", phonemes: ["f","i","n","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "line",  highlight: "ine", zh: "線", emoji: "📏", search: "line", phonemes: ["l","i","n","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "mine",  highlight: "ine", zh: "我的", emoji: "👆", search: "mine possession", phonemes: ["m","i","n","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "nine",  highlight: "ine", zh: "九", emoji: "9️⃣", search: "number nine", phonemes: ["n","i","n","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "vine",  highlight: "ine", zh: "藤", emoji: "🌿", search: "vine plant", phonemes: ["v","i","n","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "wine",  highlight: "ine", zh: "葡萄酒", emoji: "🍷", search: "wine", phonemes: ["w","i","n","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "bike",  highlight: "ike", zh: "腳踏車", emoji: "🚲", search: "bicycle bike", phonemes: ["b","i","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "hike",  highlight: "ike", zh: "健行", emoji: "🥾", search: "hike trail", phonemes: ["h","i","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "kite",  highlight: "ite", zh: "風箏", emoji: "🪁", search: "kite flying", phonemes: ["k","i","t","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "site",  highlight: "ite", zh: "地點/網站", emoji: "🌐", search: "site location", phonemes: ["s","i","t","e"], phonemesSpeak: [null, null, null, ""] }
        ],
        quiz: [
    ...
    topics: [
      {
        ...
        words: [
          { word: "bone",  highlight: "o_e", zh: "骨頭（o長音）", emoji: "🦴", search: "bone dog", phonemes: ["b","o","n","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "cone",  highlight: "o_e", zh: "圓錐（o長音）", emoji: "🍦", search: "cone ice cream", phonemes: ["c","o","n","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "home",  highlight: "o_e", zh: "家（o長音）", emoji: "🏠", search: "home house", phonemes: ["h","o","m","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "hope",  highlight: "o_e", zh: "希望（o長音）", emoji: "🌟", search: "hope star", phonemes: ["h","o","p","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "mole",  highlight: "o_e", zh: "鼹鼠（o長音）", emoji: "🦔", search: "mole animal", phonemes: ["m","o","l","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "note",  highlight: "o_e", zh: "筆記（o長音）", emoji: "📝", search: "note paper", phonemes: ["n","o","t","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "pole",  highlight: "o_e", zh: "柱子（o長音）", emoji: "🎿", search: "pole", phonemes: ["p","o","l","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "rose",  highlight: "o_e", zh: "玫瑰（o長音）", emoji: "🌹", search: "rose flower", phonemes: ["r","o","s","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "rope",  highlight: "o_e", zh: "繩子（o長音）", emoji: "🪢", search: "rope", phonemes: ["r","o","p","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "vote",  highlight: "o_e", zh: "投票（o長音）", emoji: "🗳️", search: "vote ballot", phonemes: ["v","o","t","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "cube",  highlight: "u_e", zh: "正方體（u長音）", emoji: "🧊", search: "cube ice", phonemes: ["c","u","b","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "cute",  highlight: "u_e", zh: "可愛（u長音）", emoji: "🐣", search: "cute animal", phonemes: ["c","u","t","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "dune",  highlight: "u_e", zh: "沙丘（u長音）", emoji: "🏜️", search: "sand dune", phonemes: ["d","u","n","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "mule",  highlight: "u_e", zh: "騾子（u長音）", emoji: "🐴", search: "mule donkey", phonemes: ["m","u","l","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "tune",  highlight: "u_e", zh: "曲調（u長音）", emoji: "🎵", search: "music tune", phonemes: ["t","u","n","e"], phonemesSpeak: [null, null, null, ""] }
        ],
        quiz: [

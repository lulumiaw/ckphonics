    ...
    topics: [
      {
        ...
        words: [
          ...
          { word: "turtle", highlight: "ur", zh: "烏龜", emoji: "🐢", search: "turtle", phonemes: ["t","ur","t","le"], phonemesSpeak: [null, null, null, null] },
    ...
    topics: [
      ...
      },
      {
        ...
        words: [
          ...
          { word: "want",   highlight: "wa", zh: "想要（wa）", emoji: "💭", search: "want wish", phonemes: ["w","a","nt"], phonemesSpeak: [null, "on", null] },
          { word: "wash",   highlight: "wa", zh: "洗（wa）", emoji: "🧼", search: "wash hands", phonemes: ["w","a","sh"], phonemesSpeak: [null, "on", null] },
          { word: "watch",  highlight: "wa", zh: "手錶/看（wa）", emoji: "⌚", search: "watch clock", phonemes: ["w","a","tch"], phonemesSpeak: [null, "on", null] },
    ...
    topics: [
      {
        ...
        words: [
          ...
          { word: "bread",   highlight: "ea",  zh: "麵包（ea=/ɛ/ 特例）", emoji: "🍞", search: "bread", phonemes: ["br","ea","d"], phonemesSpeak: [null, "Ed", null] },
          { word: "feather", highlight: "ea",  zh: "羽毛（ea=/ɛ/ 特例）", emoji: "🪶", search: "feather", phonemes: ["f","ea","th","er"], phonemesSpeak: [null, "Ed", null, null] },
          { word: "weather", highlight: "ea",  zh: "天氣（ea=/ɛ/ 特例）", emoji: "🌤️", search: "weather", phonemes: ["w","ea","th","er"], phonemesSpeak: [null, "Ed", null, null] },
    ...
    topics: [
      {
        ...
        words: [
          { word: "cat",   highlight: "a",   zh: "貓（短a）", emoji: "🐱", search: "cat", phonemes: ["c","a","t"], phonemesSpeak: [null, "at", null] },
          { word: "cake",  highlight: "a_e", zh: "蛋糕（長a）", emoji: "🎂", search: "cake", phonemes: ["c","a","k","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "bed",   highlight: "e",   zh: "床（短e）", emoji: "🛏️", search: "bed", phonemes: ["b","e","d"], phonemesSpeak: [null, "Ed", null] },
          { word: "tree",  highlight: "ee",  zh: "樹（長e）", emoji: "🌳", search: "tree", phonemes: ["tr","ee"] },
          { word: "sit",   highlight: "i",   zh: "坐（短i）", emoji: "🪑", search: "sit chair", phonemes: ["s","i","t"], phonemesSpeak: [null, "it", null] },
          { word: "kite",  highlight: "i_e", zh: "風箏（長i）", emoji: "🪁", search: "kite flying", phonemes: ["k","i","t","e"], phonemesSpeak: [null, null, null, ""] },
          { word: "hot",   highlight: "o",   zh: "熱（短o）", emoji: "🔥", search: "hot fire", phonemes: ["h","o","t"], phonemesSpeak: [null, "on", null] },
          { word: "boat",  highlight: "oa",  zh: "船（長o）", emoji: "⛵", search: "boat", phonemes: ["b","oa","t"] },
          { word: "cup",   highlight: "u",   zh: "杯子（短u）", emoji: "☕", search: "cup mug", phonemes: ["c","u","p"], phonemesSpeak: [null, "up", null] },
      ...
      },
      {
        ...
        words: [
          ...
          { word: "write",    highlight: "wr",   zh: "寫（w不發音）", emoji: "✍️", search: "write pen", phonemes: ["wr","i","te"], phonemesSpeak: [null, null, null, ""] },
          { word: "lamb",     highlight: "mb",   zh: "小羊（b不發音）", emoji: "🐑", search: "lamb sheep", phonemes: ["l","a","mb"], phonemesSpeak: [null, "at", null] },
          { word: "give",     highlight: "ve",   zh: "給（e讓字不以v結尾）", emoji: "🎁", search: "give gift", phonemes: ["g","i","ve"], phonemesSpeak: [null, "it", null, ""] },
          { word: "rhino",    highlight: "rh",   zh: "犀牛（h不發音）", emoji: "🦏", search: "rhino", phonemes: ["rh","i","n","o"], phonemesSpeak: [null, null, null, null] },
          ...
          { word: "famous",   highlight: "ous",  zh: "著名的（-ous）", emoji: "⭐", search: "famous star", phonemes: ["fa","m","ous"], phonemesSpeak: [null, null, null, null] },
          { word: "dangerous",highlight: "ous",  zh: "危險的（-ous）", emoji: "⚠️", search: "dangerous warning", phonemes: ["dan","ger","ous"] },
          { word: "enormous", highlight: "ous",  zh: "巨大的（-ous）", emoji: "🐋", search: "enormous whale", phonemes: ["e","nor","m","ous"], phonemesSpeak: [null, null, null, null] }
        ],
        quiz: [
